...
class RGB565Image:
    ...
    def add_text(self, text="Happy New Year!", font_size=16):
        """
        ...
        try:
            ...
            # draw.text((10, self.height - font_size - 10), text, fill=(255, 255, 255), font=font)
            draw.text(
                (10, self.height - font_size - 10), 
                text, 
                fill="white", 
                stroke_width=1,
                stroke_fill="white",
        ...
        #     # If `arial.ttf` is not available, use default font
            # draw.text((10, self.height - font_size - 10), text, fill=(255, 255, 255))
            draw.text(
                (10, self.height - font_size - 10), 
                text, 
                fill="white", 
